...
STL = ROOT / "models" / "final" / "cosplay_kunai_v3_one_piece.stl"
OUT = ROOT / "renders" / "previews" / "cosplay_kunai_v3_one_piece_preview.png"
...
draw.text((60, 766), "V3 REFERENCE KUNAI — EXACT GEOMETRY FUSED", font=title, fill="white")
draw.text((60, 823), "Original visible design • one watertight body • 280 × 45 × 25 mm", font=body, fill=(205, 212, 222))
image.save(OUT)
print(OUT)
